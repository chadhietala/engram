---
name: explore-codebase-2
description: Performs comprehensive multi-file exploration to understand system architecture, dependencies, and interaction patterns across a codebase.
metadata:
  author: engram
  version: "1.0"
  generatedAt: 2026-02-02T18:15:46.627Z
...
Use this skill when you need to build a holistic understanding of how a system works before making changes. The skill reads multiple related files in succession to map out architectural boundaries, trace dependencies, and understand component interactions. This exploration phase is especially valuable when working with unfamiliar codebases or planning significant changes that could have wide-ranging impact.

## When to Use

- Starting work on a new or unfamiliar codebase where you need to understand the overall architecture
- Planning complex features that will touch multiple parts of the system
- Investigating how different components interact before refactoring or optimization
- Understanding system boundaries and dependency patterns before making architectural decisions
- Tracing data flow or execution paths across multiple files and modules
