...
description: This skill systematically explores complex cognitive or meta-cognitive system architectures before implementation by reading theoretical patterns and abstractions across the codebase.
metadata:
  author: engram
  version: "1.0"
  generatedAt: 2026-02-02T16:04:05.205Z
...
Use this skill when encountering unfamiliar reasoning systems, cognitive architectures, or abstract theoretical frameworks. Begin by reading core architectural files to understand foundational patterns, then use Glob to discover related modules and components. Continue reading implementation files to internalize how theoretical concepts are operationalized, creating a comprehensive mental model before making changes or extensions.

## When to Use

- Working with unfamiliar cognitive or reasoning system architectures
- Exploring meta-cognitive frameworks or abstract theoretical patterns
- Needing to understand system-wide architectural principles before implementing features
- Investigating how theoretical concepts are translated into concrete implementations
- Preparing to extend or improve complex systems that require deep architectural understanding

## Steps

1. **Follow the pattern described above**
   When working with complex cognitive or meta-cognitive systems, begin with comprehensive architectural exploration to understand theoretical patterns and abstractions, then transition to active develop
