#!/usr/bin/env bun
/**
 * run-test - Auto-generated skill script
 * Generated by Engram from pattern: e86f3bf0-7414-460f-a131-4c1fb9836d7d
 *
 * Implements defensive error handling and validation in LLM API abstraction layers, then verifies system reliability through end-to-end execution testing.
 */
